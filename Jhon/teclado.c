...
{       
        ...
        output_high(F1);
        delay_ms(200);
        if(tecla==7){output_low(PIN_D1); return('A');}
        if(tecla==11){output_high(PIN_D2);return('3');}
      if(tecla==13){output_high(PIN_D0);return('2');}
      if(tecla==14){output_high(PIN_D1);return('1');}
        }
        output_high(F1);
      ...
      output_high(F2);
      delay_ms(200);
        if(tecla==7){output_low(PIN_D0);return('B');}
      ...
      output_high(F3);
       delay_ms(200);
        if(tecla==7){output_low(PIN_D2);return('C');}
      ...
      output_low(F4); 
       ...
       output_high(F4);
        delay_ms(200);      
        if(tecla==7){output_low(PIN_D1);output_low(PIN_D0);output_low(PIN_D2);return('D');}
        if(tecla==11)return('#');
...
PLLEN = 1;          //Habilita PLL para generar 48MHz de oscilador*/\ 
   ...
   for(i=0;i<4;i++){ 
   printf(lcd_putc_4bits,"\f LED1 EN ON  \n OPRIMA 1"); //
   delay_ms(400);
   }
   
   for(i=0;i<4;i++){ 
   printf(lcd_putc_4bits,"\f LED1 EN OFF  \n OPRIMA A"); //
   delay_ms(400);
   }

   for(i=0;i<4;i++){ 
   printf(lcd_putc_4bits,"\f LED2 EN ON  \n OPRIMA 2"); //
   delay_ms(400);
   }
   
   for(i=0;i<4;i++){ 
   printf(lcd_putc_4bits,"\f LED2 EN OFF  \n OPRIMA B"); //
   delay_ms(400);
   }
   
   for(i=0;i<4;i++){ 
   printf(lcd_putc_4bits,"\f LED3 EN ON  \n OPRIMA 3"); //
   delay_ms(400);
   }
   
   for(i=0;i<4;i++){ 
   printf(lcd_putc_4bits,"\f LED3 EN OFF  \n OPRIMA C"); //
   delay_ms(400);
   }
